#ifndef _HELLO_WORLD_NATIVE_APP_H_
#define _HELLO_WORLD_NATIVE_APP_H_
...
//  The [helloWorldNative]App class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class helloWorldNativeApp
...
public:
	...
	helloWorldNativeApp(void);
	virtual ~helloWorldNativeApp(void);
...
#endif // _HELLO_WORLD_NATIVE_APP_H_
